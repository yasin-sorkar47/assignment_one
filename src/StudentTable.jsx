import {
  studentDataOfClassOne,
  studentDataOfClassThree,
  studentDataOfClassTwo,
} from "./Data";
        ...
        <div className="max-w-[848px] mx-auto overflow-auto">
          <table className="w-full">
            ...
            <tbody>
              ...
              {studentDataOfClassOne.map((student) => {
                return (
                  <>
                    <tr
                      key={student.id}
              ...
              {studentDataOfClassTwo.map((student) => {
                return (
                  <>
                    <tr
                      key={student.id}
              ...
              {studentDataOfClassThree.map((student) => {
                return (
                  <>
                    <tr
                      key={student.id}
